...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Db_We_wq.mjs");
...
var manifest = {
	"162d48fa658984f13d31f7a0d7defe01875ec6a577067b092022baf72c3c1676": {
		functionName: "askCortex_createServerFn_handler",
		importer: () => import("./chat-6PjxwItL.mjs")
	},
	"3866edd3fbdd190840740497a0b5534ad043baa377ed8709455eef81bc40f0f8": {
		functionName: "enrichPlaybook_createServerFn_handler",
		importer: () => import("./enrich-Ca2t-Lqk.mjs")
	},
	"587c4dd46f139d53c317cdc6a471a65f2e13e419469936e414b350d1187ba3d6": {
		functionName: "probeSystem_createServerFn_handler",
		importer: () => import("./probe-3tN7qrNf.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D6386i8S.mjs").then((n) => n.t),
